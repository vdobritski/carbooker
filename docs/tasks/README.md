...
| 024 | — | `trip_plan_points`: the itinerary |
| 025 | — | `sort_order` on stops: drag to reorder, instead of sorting by time |
| 026 | — | `move_plan_point()`: drag a stop into another day |
| 027 | — | the itinerary comes back out of `public_trip()` |
